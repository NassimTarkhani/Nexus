module.exports = [
"[project]/frontend/src/lib/debugAuth.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function debugAuth() {
    ...
    if (session?.user.id) {
        const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('id', session.user.id).single();
    ...
    try {
        const { error: connectionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('count', {
            count: 'exact',
            head: true
        });
        if (connectionError) {
...
async function checkUserExists(email) {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, email, role, created_at').eq('email', email).single();
    if (error) {
...
//# sourceMappingURL=frontend_src_lib_debugAuth_ts_b8cabb48._.js.map