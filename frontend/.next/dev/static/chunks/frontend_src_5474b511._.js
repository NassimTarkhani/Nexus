...
"[project]/frontend/src/lib/services/documents.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const documentsService = {
    ...
    async getDocuments (userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('documents').select('*').eq('user_id', userId).order('created_at', {
            ascending: false
        });
        if (error) {
    ...
    async getDocumentById (id) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('documents').select('*').eq('id', id).single();
        if (error) {
    ...
    async createDocument (doc) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('documents').insert(doc).select().single();
        if (error) throw error;
        return data;
    },
    // Update document
    async updateDocument (id, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('documents').update(updates).eq('id', id).select().single();
        if (error) throw error;
        return data;
    },
    // Delete document (chunks cascade)
    async deleteDocument (id) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('documents').delete().eq('id', id);
        if (error) throw error;
    },
    // Get chunks for a document
    async getChunks (documentId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('document_chunks').select('*').eq('document_id', documentId).order('chunk_index', {
            ascending: true
        });
        if (error) throw error;
        return data || [];
    ...
    async insertChunks (chunks) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('document_chunks').insert(chunks);
        if (error) throw error;
    },
    // Search chunks by simple text match (MVP — replace with pgvector later)
    async searchChunks (documentId, query, limit = 5) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('document_chunks').select('*').eq('document_id', documentId).ilike('content', `%${query}%`).order('chunk_index', {
            ascending: true
        }).limit(limit);
        if (error) throw error;
        return data || [];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$services$2f$documents$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/services/documents.ts [app-client] (ecmascript)");
;
;
;
;
...
"[project]/frontend/src/components/AuthInitializer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthInitializer() {
    _s();
    const initAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "AuthInitializer.useAuthStore[initAuth]": (s)=>s.initAuth
...
//# sourceMappingURL=frontend_src_5474b511._.js.map